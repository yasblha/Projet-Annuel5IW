...
const roles_decorator_1 = require("../infrastructure/guards/roles.decorator");
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Invite a new user (Admin only)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all users in the agency' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Return all users in the agency' }),
